...
struct Box
{
    ...
    */
    ...
    /*
    ****NOTE*****
    1) if the character collides with an object then: i) If he collides from above then just bring velocity to 0 (gravity will keep applying but will have no effect)
                                                      ii) If he collides sideways then dont do nun
                                                      iii) If he hits something from below then just bring velocity to 0
    ...
    */
    float intersectAbove(Box& other)
    {
